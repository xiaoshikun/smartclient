...
public class AndroidTaskCallable implements Callable<String> {
    ...
    public AndroidTaskCallable(String cmd,String anLogFile){
        this.cmd = cmd;
    ...
    public String call() throws Exception {
        ...
        File apkLogOutDir = new File(anLogFile+ File.separator+new DateTime(nowDate).toString("yyyy")+ File.separator + new DateTime(nowDate).toString("MM"));

        if(!apkLogOutDir.exists()){
            apkLogOutDir.mkdirs();
        }
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd HH-mm-ss");
        File apkLogFile = new File(apkLogOutDir+File.separator+sdf.format(nowDate)+".log");
